...
public class RecyclerBiddingFinishedOffersAdapter extends RecyclerView.Adapter<RecyclerBiddingFinishedOffersAdapter.ViewHolder> {

    private ArrayList<Product> products;
    private Context context;
    private FirebaseAuth fAuth;
    private FirebaseUser fUser;
    public RecyclerBiddingFinishedOffersAdapter(Context context,ArrayList<Product> products) {
    ...
    @NonNull
    @Override
    public RecyclerBiddingFinishedOffersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_myauctions,parent,false);
        fAuth = FirebaseAuth.getInstance();
        fUser = FirebaseAuth.getInstance().getCurrentUser();
        return new RecyclerBiddingFinishedOffersAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerBiddingFinishedOffersAdapter.ViewHolder holder, int position) {
