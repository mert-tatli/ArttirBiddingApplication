...
public class RecyclerBiddingItemAdapter extends RecyclerView.Adapter<RecyclerBiddingItemAdapter.ViewHolder> {
    ...
    public RecyclerBiddingItemAdapter(Context context,ArrayList<Product> products) {
    ...
    @NonNull
    @Override
    public RecyclerBiddingItemAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_myauctions,parent,false);
        fAuth = FirebaseAuth.getInstance();
        fUser = FirebaseAuth.getInstance().getCurrentUser();
        return new RecyclerBiddingItemAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerBiddingItemAdapter.ViewHolder holder, int position) {
